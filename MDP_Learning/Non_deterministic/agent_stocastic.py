import numpy as np
import random
from qlearning.environment_stocastic import Env #이부분을 교수님파일에 맞게 수정해주세용
...
class QLearningAgent:
    ...
    def learn(self, state, action, reward, next_state):
        ...
        #learning rate를 적용시켜 큐함수를 더욱 천천히 업데이트
...
if __name__ == "__main__":
    ...
    for episode in range(1,1000):
        ...
        while True:
            ...
            next_state, reward, real_action, done = env.step(action)
        ...
        print(episode, "th episode, number of state:", l, 'final reward = ', reward_table[-1])
