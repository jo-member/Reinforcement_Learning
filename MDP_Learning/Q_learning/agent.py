import numpy as np
import random
from qlearning.environment import Env #이부분을 교수님파일에 맞게 수정해주세용
...
if __name__ == "__main__":
    ...
    for episode in range(1,1000):
        ...
        print(episode, "th episode's return vale")
        for k in range(len(return_table)):
            print("G(s%d) = %.4f" %(k+1,return_table[k]))
